...
(function () {
    ...
    var mouseInteraction = (function () {
        ...
        return function (e) {
            ...
            mouseVector.z = 0;
            if (retina) {
                // mouseVector.x = mouseVector.x + 0.5;
                // mouseVector.y = mouseVector.y - 0.5;
                mouseVector.x = 4 * e.clientX / e.currentTarget.width - 1;
                mouseVector.y = - 4 * e.clientY / e.currentTarget.height + 1;
            }
            ...
            // if(retina){
            //     distance = - camera.position.z*1.01 / mouseVector.z;
            // }
    ...
    function init(success) {
        ...
        loadObjModel({
            ...
            objName: 'assets/libs/threejs/eagle.obj'
        }, function (object) {
            ...
            textureLoader.load('assets/images/particle.jpg', function (backgroundTexture) {
    ...
    // getOS().os;
    var vOS = getOS();
    if (vOS == 'Mac OS' || vOS == 'Windows') {
        setTimeout(function(){
            canvas = document.getElementById('eagle');
            init(update);
        }, 3000)
